...
def main():
    ...
    print("  └── training/")
    print("      ├── image_2/     # Images")
    print("      ├── label_2/     # Labels")
    print("      └── calib/       # Calibration files")
    print()
    print("Next steps:")
    print("  1. Run prepare_kitti_coco.py to convert to COCO format")
    print("  2. Train your model with train_distillation.py")
